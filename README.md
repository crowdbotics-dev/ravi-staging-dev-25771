...
## Project Structure
    ...
    ├── ravi_staging_dev_25771  # Django project configurations
...
1. Clone this repo and `cd ravi_staging_dev_25771`
...
2. Clone this repo and `cd ravi_staging_dev_25771`
